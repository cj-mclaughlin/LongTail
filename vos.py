...
def fit_ccg(feat_train, labels_train, num_classes=10):
    """
...
def sample_ccg(means, prec, class_index=0, num_samples=1000, likelihood="lowest"):
    ...
    samples = dist.rsample((num_samples * 10,))
...
if __name__ == "__main__":
    ...
    resampled_data = vos_sampling_step(feat_train, labels_train, N_SAMPLES_PER_CLASS, likelihood="lowest")
